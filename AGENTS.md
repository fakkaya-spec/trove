...
- **Platform yeteneği testi + OPSİYONELLİK:** her yeni özellikte sor —
  "bu tek başına bir iş olabilir mi?" (ikmal, kanıt, sefer raporları, AI
  denizci asistanı, bakım geçmişi: evet). Evetse ürün/API/ortaklık/AI/B2B
  yönüne EVRİLEBİLECEK şekilde tasarla — EVRİLMEK ZORUNDA kalacak şekilde
  değil: saf domain motoru + repository + tipli veri, UI'dan ayrılabilir.
  Kapıları açık bırak; henüz içinden GEÇME: hayalî müşteri için inşaat yok,
  "belki lazım olur" mimarisi yok, kullanıcısı olmayan API yok, müşterisi
  olmayan B2B özelliği yok.
- **90/10 kuralı:** eforun %90'ı bugünün sorununa, %10'u yarını imkânsız
  kılmamaya. Bu oran ASLA ters çevrilmez.
- **Kuzey yıldızı:** her sürüm TROVE'u daha BÜYÜK, daha etkileyici veya
  daha karmaşık değil — sadece DAHA FAYDALI hissettirmelidir.
